...
split: entity-disjoint | train/test: 113/76 (seed 0)
...
> - small N (test=76): single-digit anti-fab counts drive the gate; one row can flip a verdict — treat deltas as directional, not significant.
...
## full_classifier
- family_accuracy: 0.776
- skill_accuracy: 0.8947368421052632
...
split: paraphrase-disjoint | train/test: 113/76 (seed 0)
