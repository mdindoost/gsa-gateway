...
_ASK_SYSTEM = (
    ...
    "- If the context is only partially relevant or the query is vague, extract whatever "
    "useful information you can and answer as much as possible. For example, if a student "
    "asks about 'fund' and the context mentions Travel Awards, DepRep Funding, and Research "
    "Day prizes — explain all of them. Do not say you don't know just because the query "
    "was short or vague.\n"
    "- Always be specific: mention real amounts, real emails, real deadlines when they "
