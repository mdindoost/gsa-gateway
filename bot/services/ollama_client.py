...
class OllamaClient:
    ...
    async def compose_from_rows(self, question: str, facts: str) -> Optional[str]:
        ...
        system_prompt = (
            ...
            "to attributes that are listed. Preserve any parenthetical qualifier on an "
            "appointment EXACTLY — e.g. '(affiliated)' or '(joint appointment)' — never "
            "drop it; it marks a non-home role and changing it alters the meaning. "
