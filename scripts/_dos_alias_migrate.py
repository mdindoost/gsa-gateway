"""One-off gated migration: add name aliases to the Dean of Students org (id 20).
...
NEW_ALIASES = ["dean of students", "dos", "office of the dean of students"]
...
def run(db: str, commit: bool) -> int:
    ...
    try:
        ...
        hardened_backup(db, label="dos-alias")
        meta["aliases"] = merged
