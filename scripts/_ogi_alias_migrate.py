"""One-off gated migration: add name aliases to the OGI org (id 16).

Org 16 slug is `ogi` (resolves the acronym) and name "Office of Global Initiatives". This adds the
spaced name phrasings students use ("global initiatives", "office of global initiatives") so those
...
SLUG = "ogi"
NEW_ALIASES = ["global initiatives", "office of global initiatives"]
...
def run(db: str, commit: bool) -> int:
    ...
    try:
        ...
        hardened_backup(db, label="ogi-alias")
        meta["aliases"] = merged
