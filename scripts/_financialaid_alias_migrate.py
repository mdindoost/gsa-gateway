"""One-off gated migration: add name aliases to the Financial Aid org (id 28).

Org 16 slug is `financialaid` and name "Office of Financial Aid". This adds the phrasings students use
("financial aid", "student financial aid services", "sfas") so those
...
SLUG = "financialaid"
NEW_ALIASES = ["financial aid", "financial aid office", "student financial aid services", "sfas"]
...
def run(db: str, commit: bool) -> int:
    ...
    try:
        ...
        hardened_backup(db, label="financialaid-alias")
        meta["aliases"] = merged
